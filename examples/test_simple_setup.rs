...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "      IMAP: {}:{}",
        gmail_config.imap_server, gmail_config.imap_port
    );
    println!(
        "      SMTP: {}:{}",
        gmail_config.smtp_server, gmail_config.smtp_port
    );
    ...
    println!(
        "      IMAP: {}:{}",
        outlook_config.imap_server, outlook_config.imap_port
    );
    println!(
        "      SMTP: {}:{}",
        outlook_config.smtp_server, outlook_config.smtp_port
    );
