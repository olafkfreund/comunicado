    ...
    pub fn outlook() -> Self {
        Self {
            ...
            scopes: vec![
                ...
                OAuth2Scope::OutlookContacts, // Access to Outlook Contacts
            ],
    ...
    pub fn setup_instructions(&self) -> Vec<String> {
        match &self.provider {
            OAuth2Provider::Gmail => vec![
                ...
                "   - https://www.googleapis.com/auth/contacts.readonly (Read Contacts)".to_string(),
                "7. Add test users: Add your Gmail address to test users list".to_string(),
                "8. Save and continue through all steps".to_string(),
                "".to_string(),
                "STEP 2: Enable APIs".to_string(),
                "9. Go to 'APIs & Services' > 'Library'".to_string(),
                "10. Search for 'Gmail API' and click 'Enable'".to_string(),
                "11. Search for 'People API' and click 'Enable' (for contacts access)".to_string(),
                "".to_string(),
                "STEP 3: Create OAuth Client".to_string(),
                "12. Go to 'APIs & Services' > 'Credentials'".to_string(),
                "13. Click '+ CREATE CREDENTIALS' > 'OAuth client ID'".to_string(),
                "14. Select 'Desktop application' as the application type".to_string(),
                "15. Give your OAuth client a name (e.g., 'Comunicado Desktop')".to_string(),
                "16. IMPORTANT: Add authorized redirect URIs (required for port flexibility):".to_string(),
                ...
                "    - http://localhost:8083/oauth/callback".to_string(),
                "    - http://localhost:8084/oauth/callback".to_string(),
                "    (Comunicado uses dynamic ports 8080-8089 to avoid conflicts)".to_string(),
                "17. Click 'CREATE'".to_string(),
                "18. Copy the 'Client ID' from the popup".to_string(),
                "19. Copy the 'Client Secret' (required for desktop apps)".to_string(),
                "".to_string(),
                ...
                "  - MUST register multiple redirect URIs (ports 8080-8084)".to_string(),
                "  - Comunicado uses dynamic ports to avoid conflicts".to_string(),
                "  - If port 8080 is in use, it will try 8081, 8082, etc.".to_string(),
                "  - Try changing to 'Web application' type if Desktop fails".to_string(),
                "• Error shows port 8081 but expecting 8080:".to_string(),
                "  - This means port 8080 was busy, app used 8081".to_string(),
                "  - Register all ports 8080-8084 to fix this".to_string(),
                "".to_string(),
            ...
            OAuth2Provider::Outlook => vec![
                ...
                "13. Add: Mail.Read, Mail.ReadWrite, Mail.Send, Contacts.Read, offline_access".to_string(),
