...
impl KeyboardShortcutsUI {
    ...
    fn get_action_description(&self, action: &KeyboardAction) -> &'static str {
        match action {
            ...
            KeyboardAction::OpenAttachmentWithSystem => {
                "Open attachment with system app (content preview)"
            }
            ...
            KeyboardAction::AIEmailSuggestions => {
                "Get AI suggestions for current email (message list/preview)"
            }
            KeyboardAction::AIComposeSuggestions => {
                "AI assistance for email composition (compose mode)"
            }
            KeyboardAction::AISummarizeEmail => {
                "Generate AI summary of current email (message list/preview)"
            }
            ...
            KeyboardAction::AIQuickReply => {
                "Generate quick reply suggestions (message list/preview)"
            }
            KeyboardAction::AIEmailAnalysis => {
                "Analyze email content with AI (message list/preview)"
            }
            KeyboardAction::AIScheduleRequest => {
                "Parse scheduling requests with AI (message list/preview)"
            }
